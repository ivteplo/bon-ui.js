...
export class ApplicationManager {
     ...
     * @param {Object}          [options]
     * @todo  Support for icon on microsoft and apple devices (msapplication and apple-touch)
     */
     ...
     * @param {Object}  options
     * @param {Node}    [options.ssrNode] Node that will be used for hydration in case if the view was rendered from the server side
     */
    loadApp(options = {}) {
        const promises = Promise.all([
            ...
            new Promise((resolve, reject) => {
                if (options.ssrNode && options.ssrNode instanceof Node) {
                    this.hydrateView(options.ssrNode)
                } else {
                    this.mountView()
                }
